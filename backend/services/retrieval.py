...
def retrieve_context(query: str, top_k: int = TOP_K, exclude_id: str = None, lab_id: str = None) -> list[dict]:
    """
    ...
    try:
        ...
        past_exps = search_past_experiments(query, limit=top_k // 3 + 1, exclude_id=exclude_id, lab_id=lab_id)
