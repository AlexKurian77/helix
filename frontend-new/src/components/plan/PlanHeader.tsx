...
const HeaderBtn = ({ children, onClick }: { children: React.ReactNode; onClick?: () => void | Promise<void> }) => (
  <button onClick={onClick} className="text-xs px-2.5 py-1 rounded text-muted-foreground hover:text-foreground hover:bg-surface-sunken transition-colors">
    {children}
  </button>
);
